...
Route.get('/api/checkout/checkout', 'CheckoutController.checkout').as('checkout').middleware(['auth:api'])
Route.post('/api/checkout/process', 'CheckoutController.processPayment').middleware(['auth:api'])
